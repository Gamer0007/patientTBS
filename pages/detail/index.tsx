...
import PhysiotherapistDetailForm1 from "../../components/organisms/PhysiotherapistDetailForm1";
import TopUpItem from "../../components/organisms/PhysiotherapistDetailItem1";
import Navbar from "../../components/organisms/Navbar";
import { useRouter } from 'next/router';
import { useCallback, useEffect, useState } from "react";
import { getDetailVoucher } from "../../services/player";
import PhysiotherapistDetailItem1 from "../../components/organisms/PhysiotherapistDetailItem1";
        ...
        <div className="container-xxl container-fluid">
            ...
            <div className="row">
                <div className="col-xl-3 col-lg-4 col-md-5 pb-30 pb-md-0 pe-md-25 text-md-start">
                   <PhysiotherapistDetailItem1 type='mobile'/>
                </div>
                <div className="col-xl-9 col-lg-8 col-md-7 ps-md-25">
                    <PhysiotherapistDetailItem1  type='Om Rama'/>
                    <hr/>
                <PhysiotherapistDetailForm1 />

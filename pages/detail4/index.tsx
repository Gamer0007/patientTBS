...
import PhysiotherapistDetailForm4 from "../../components/organisms/PhysiotherapistDetailForm4";
import PhysiotherapistDetailItem4 from "../../components/organisms/PhysiotherapistDetailItem4";
        ...
        <div className="container-xxl container-fluid">
            ...
            <div className="row">
                <div className="col-xl-3 col-lg-4 col-md-5 pb-30 pb-md-0 pe-md-25 text-md-start">
                   <PhysiotherapistDetailItem4 type='mobile'/>
                </div>
                <div className="col-xl-9 col-lg-8 col-md-7 ps-md-25">
                    <PhysiotherapistDetailItem4  type='aldo'/>
                    <hr/>
                <PhysiotherapistDetailForm4 />
